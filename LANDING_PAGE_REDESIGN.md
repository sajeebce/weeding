...
│  ├── hero-split-dashboard- Text left, dashboard visual rt  │
...
interface HeroBlock {
  ...
  settings: {
    // Layout Variant
    variant: "centered" | "split" | "split-dashboard" | "slider" | "with-form" | "video" | "minimal";
    ...
    headline: {
      ...
      // ═══════════════════════════════════════════════════════════════
      // ANIMATED WORDS FEATURE
      // ═══════════════════════════════════════════════════════════════
      // Instead of static highlight, rotating words animate in place
      // Example: "Drive your business [Growth → Success → Revenue]"
      animatedWords?: {
        enabled: boolean;
        words: string[]; // e.g., ["Growth", "Success", "Revenue", "Future"]
        animation: {
          type: "slide-up" | "fade" | "typewriter" | "flip";
        ...
        style: {
          ...
          customColor?: string;
          underline: boolean; // Animated underline beneath word
    ...
    visual?: {
      ...
      // ═══════════════════════════════════════════════════════════════
      // DASHBOARD PRESET VISUALS (for split-dashboard variant)
      // ═══════════════════════════════════════════════════════════════
      // Pre-built dashboard mockups with hover effects
      // Inspired by shadcn/studio Hero 23 design
      dashboardPreset?: {
        // Pre-built presets (admin selects one)
        preset: "analytics" | "ecommerce" | "saas" | "crm" | "custom";

        // Preset Descriptions:
        // "analytics" - Dashboard with charts, metrics, graphs (Hero 23 style)
        // "ecommerce" - Product listings, order stats, revenue cards
        // "saas"      - User metrics, subscription stats, usage graphs
        // "crm"       - Contact lists, pipeline, deal tracking
        // "custom"    - Admin uploads custom SVG/image

        // Custom image (when preset = "custom")
        customImageUrl?: string;
        customSvgUrl?: string;

        // Interaction effects on hover
        interactionEffect: {
          type: "none" | "parallax" | "float" | "tilt-3d" | "glow";
        ...
        style: {
          ...
          scale: number; // 0.8 - 1.2 (default 1)
...
┌─────────────────────────────────────────────────────────────┐
│  HERO VARIANT: SPLIT-DASHBOARD (shadcn/studio Hero 23)     │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│   ┌─────────────────────┬───────────────────────────────┐  │
│   │                     │                               │  │
│   │  Drive your         │  ┌─────────────────────────┐ │  │
│   │  business           │  │░░░ DASHBOARD VISUAL ░░░░│ │  │
│   │  [Growth →]         │  │                         │ │  │
│   │  ════════════       │  │  ┌────┐ ┌────┐ ┌────┐  │ │  │
│   │                     │  │  │📈 │ │💰 │ │👥 │  │ │  │
│   │  Sub-headline text  │  │  │    │ │    │ │    │  │ │  │
...
KEY FEATURES:
- Animated headline word: "Growth" → "Success" → "Revenue" → "Future"
  (slide-up animation, cycles every 3 seconds)
- Avatar stack with "+500" counter (social proof)
- Star rating display
- Dashboard visual on right with hover interaction effects
- Logo bar with continuous marquee scroll
```

**Dashboard Preset Options (4-5 Pre-built Designs):**

```
┌─────────────────────────────────────────────────────────────┐
│  DASHBOARD PRESETS GALLERY                                  │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  ┌────────────────────┐  ┌────────────────────┐            │
│  │ 1. ANALYTICS       │  │ 2. ECOMMERCE       │            │
│  │ (Hero 23 Style)    │  │                    │            │
│  │ ┌──┐ ┌──┐ ┌──┐    │  │ ┌──────────────┐  │            │
│  │ │📊│ │💵│ │📈│    │  │ │ Product Grid │  │            │
│  │ └──┘ └──┘ └──┘    │  │ ├──┬──┬──┬──┤  │            │
...
│  │ │▆▇█▅▆▇ Graph │  │  │ └──┴──┴──┴──┘  │            │
│  │ └──────────────┘  │  │ Revenue: $12.5K   │            │
│  │ • Metric cards    │  │ • Product cards    │            │
│  │ • Area charts     │  │ • Order stats      │            │
│  │ • Progress bars   │  │ • Revenue graphs   │            │
│  └────────────────────┘  └────────────────────┘            │
│                                                             │
│  ┌────────────────────┐  ┌────────────────────┐            │
│  │ 3. SAAS            │  │ 4. CRM             │            │
│  │                    │  │                    │            │
│  │ ┌──────────────┐  │  │ ┌──────────────┐  │            │
│  │ │ Users: 2,451 │  │  │ │ Pipeline     │  │            │
│  │ │ ████████░░░  │  │  │ │ ┌─┬─┬─┬─┐   │  │            │
│  │ │ Active: 89%  │  │  │ │ │ │ │ │ │   │  │            │
│  │ └──────────────┘  │  │ │ └─┴─┴─┴─┘   │  │            │
│  │ • User metrics    │  │ │ Deals: $45K    │  │            │
│  │ • Usage stats     │  │ └──────────────┘  │            │
│  │ • Subscription    │  │ • Contact list     │            │
│  │   progress bars   │  │ • Deal tracking    │            │
│  └────────────────────┘  └────────────────────┘            │
│                                                             │
│  ┌────────────────────┐                                    │
│  │ 5. CUSTOM          │                                    │
│  │                    │                                    │
│  │  ┌──────────────┐ │  Admin can upload:                 │
│  │  │ [Upload SVG] │ │  • Custom SVG file                 │
│  │  │  or Image    │ │  • PNG/WEBP image                  │
│  │  └──────────────┘ │  • Any dashboard mockup            │
│  │                    │                                    │
│  │  Same hover effects│                                    │
│  │  apply to custom   │                                    │
│  │  uploads           │                                    │
...
│                                                             │
│  1. PARALLAX                                                │
│     Dashboard elements move at different speeds             │
│     based on mouse position. Subtle depth effect.          │
│     ┌─────────────┐                                        │
...
│                                                             │
│  2. FLOAT                                                   │
│     Dashboard gently floats up/down continuously.          │
│     Subtle breathing animation.                            │
│     ┌─────────────┐                                        │
│     │             │ ↑                                       │
│     │  Dashboard  │ │ ~5px up/down                         │
│     │             │ ↓                                       │
│     └─────────────┘                                        │
│                                                             │
│  3. TILT-3D                                                │
│     Dashboard tilts toward mouse cursor.                   │
...
│     Brand color radiates from dashboard.                   │
│     ┌─────────────┐                                        │
│     │░░░░░░░░░░░░░│ ← Glow aura                           │
│     │░ Dashboard ░│                                        │
│     │░░░░░░░░░░░░░│                                        │
...
│                                                             │
│  INTENSITY LEVELS:                                         │
│  • Subtle  - Very gentle, professional                     │
│  • Medium  - Noticeable but not distracting               │
│  • Strong  - Bold, attention-grabbing                      │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```

**Admin Panel UI for Split-Dashboard Hero:**

```
┌─────────────────────────────────────────────────────────────┐
│  HERO BLOCK: Split-Dashboard Settings                      │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  HEADLINE SETTINGS                                         │
│  ─────────────────────────────────────────────────────────  │
...
│  Animation:                                                │
│  Type:           [Slide Up      ▼]                        │
│  Duration:       [3000] ms (per word)                     │
│  Transition:     [500 ] ms                                │
│  Pause on Hover: [✓]                                      │
│                                                             │
│  Style:                                                    │
│  Color:          [Primary       ▼]                        │
│  Underline:      [ ] Enable animated underline            │
│  Background:     [✓] Show pill background                 │
│                                                             │
│  PREVIEW: "Drive your business [Growth]"                   │
│           ↓ (slides up to)                                │
...
│  Select Preset:                                            │
│  ┌─────────────────────────────────────────────────────┐   │
│  │ ○ Analytics (Hero 23 style) - Charts & Metrics      │   │
│  │ ● Ecommerce - Product grids & Revenue               │   │
│  │ ○ SaaS - User stats & Subscriptions                 │   │
│  │ ○ CRM - Pipeline & Deal tracking                    │   │
│  │ ○ Custom - Upload your own image/SVG                │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
│  Or upload custom:                                         │
│  ┌─────────────────────────────────────────────────────┐   │
│  │                                                     │   │
│  │     [Click to upload SVG or image]                 │   │
...
│  TRUST ELEMENTS                                            │
│  ─────────────────────────────────────────────────────────  │
│  Avatar Stack:   [✓] Show avatar stack                    │
│  Count Text:     [+500 entrepreneurs               ]      │
