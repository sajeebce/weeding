...
export function getTicketCreatedEmail(data: TicketCreatedEmailData): {
  ...
  const { customerName, ticketNumber, subject, message, dashboardUrl } = data;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="color: #3f3f46; margin: 0 0 20px 0; font-size: 16px; line-height: 1.6;">
                Thank you for contacting LLCPad Support. We've received your request and a member of our team will respond as soon as possible.
              </p>
              ...
              <!-- Original Message -->
              <div style="background-color: #fafafa; border-left: 4px solid #2563eb; padding: 15px 20px; margin: 20px 0;">
          ...
          <tr>
            <td style="background-color: #f4f4f5; padding: 30px 40px; text-align: center;">
              <p style="color: #71717a; margin: 0 0 10px 0; font-size: 14px;">
                Need immediate assistance? Reply to this email.
              </p>
